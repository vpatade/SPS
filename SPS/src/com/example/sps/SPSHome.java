...
public class SPSHome extends Activity {
	...
	public int computeResults(String userChoice, String computerChoice) {
		...
		if (userChoice != null && computerChoice != null) {
			if (userChoice.equalsIgnoreCase(computerChoice)) {
				result = 0;
			} else if (userChoice.equalsIgnoreCase(getResources().getString(
					R.string.SCISSORS))) {
				if (computerChoice.equalsIgnoreCase(getResources().getString(
						R.string.STONE))) {
					result = -1;
				} else if (computerChoice.equalsIgnoreCase(getResources()
	...
	public void displayResults(View view, int result, String computerMove) {
		...
		if (userScore == 5 || computerScore == 5) {
			resultText.setText((((userScore > computerScore ? "USER"
